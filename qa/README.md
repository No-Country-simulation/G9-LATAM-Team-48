...
| [api-url.ps1](./api-url.ps1) | URL canónica prod OCI (`ENERGY_API_URL` opcional; default `163.176.248.56:8080`) |
| [smoke-api.ps1](./smoke-api.ps1) | Probes HTTP de solo lectura contra API prod |
...
- Si GitGuardian alertó una **App Password de Gmail** u otra clave real: **revocala ya** en Google / Resend y generá una nueva; un commit que la quite del código **no borra** el historial de GitHub.
