...
export const APP_LANGUAGES = [
  ...
  { code: 'ar', label: 'AR', name: 'العربية', fullUi: true },
  { code: 'zh', label: 'ZH', name: '中文', fullUi: true },
  { code: 'ja', label: 'JA', name: '日本語', fullUi: true },
  { code: 'ko', label: 'KO', name: '한국어', fullUi: true },
  { code: 'ru', label: 'RU', name: 'Русский', fullUi: true },
  { code: 'hi', label: 'HI', name: 'हिन्दी', fullUi: true },
  { code: 'uk', label: 'UK', name: 'Українська', fullUi: true },
  { code: 'vi', label: 'VI', name: 'Tiếng Việt', fullUi: true },
  { code: 'id', label: 'ID', name: 'Bahasa Indonesia', fullUi: true },
  { code: 'sv', label: 'SV', name: 'Svenska', fullUi: true },
