...
export const pagesEs = {
  ...
  dashboard: {
    ...
    kpiTotalCost: 'Total costo (periodo)',
    kpiTotalUsageYear: 'Total consumo (año)',
  ...
  chart: {
    ...
    axisMonth: 'Mes',
    axisKwh: 'kWh',
    costTitle: 'Costo estimado mensual (USD)',
    costHint: 'Costo estimado asociado al consumo de cada mes.',
    variationKwhTitle: 'Variación mensual del consumo (%)',
    variationKwhHint: 'Cambio porcentual respecto al mes anterior (kWh).',
    variationCostTitle: 'Variación mensual del costo (%)',
  ...
  analysis: {
    ...
    statusSending: 'Enviando datos…',
    statusAnalyzing: 'Analizando…',
    statusDone: 'Terminado',
    statusStepSend: 'Enviando',
    statusStepAnalyze: 'Analizando',
    statusStepDone: 'Terminado',
    ...
    noTips: 'Sin sugerencias para este análisis.',
    tipsTable: {
      priority: 'Prioridad',
  ...
  historiaConsumos: {
    ...
    filterPeriodAll: 'Todas las fechas',
    filterPeriod7: 'Últimos 7 días',
    ...
    kpiCount: 'Consultas',
    kpiAvgKwh: 'Promedio kWh',
    kpiAvgSavings: 'Ahorro promedio',
  },
  contact: {
    title: 'Contáctanos',
