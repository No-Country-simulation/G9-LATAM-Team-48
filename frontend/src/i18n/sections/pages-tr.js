export const pagesTr = {
  ...
  "analysis": {
    ...
    "loginRequired": "Analiz raporunu e-posta ile almak için giriş yapın veya kaydolun.",
    "emailLoginHint": "Analiz raporunu e-posta ile almak için giriş yapın veya kaydolun.",
    ...
    "tipsList": {
      ...
      "commercial": "Ticari mekânın saatlerini ve ekipmanını optimize edin",
      "house": "Evde yalıtım ve verimli iklimlendirmeye öncelik verin",
      "apartment": "Ortak alanları kullanın ve dairede bekleme tüketimini azaltın",
      "default": "LED aydınlatmaya ve verimli cihazlara öncelik verin",
  ...
  adminUsers: {
    ...
    passwordOptionalCreate: 'Şifre (isteğe bağlı)',
    passwordAutoHint: 'Boş bırakılırsa geçici bir şifre oluşturur ve e-posta ile göndeririz.',
    temporaryPassword: 'Geçici şifre',
    emailStatus: 'E-posta durumu',
    createdTitle: 'Kullanıcı oluşturuldu. Bu bilgileri kaydedin (şifre yalnızca bir kez görünür).',
    dismiss: 'Kapat',
    ...
    verified: 'Doğrulandı',
    verifiedYes: 'Evet',
    verifiedNo: 'Beklemede',
    emailVerified: 'E-posta doğrulandı (bağlantısız giriş)',
    emailVerifiedHint: 'İşaretlenirse kullanıcı giriş için e-posta doğrulamak zorunda değildir.',
    actions: 'İşlemler',
    edit: 'Düzenle',
    delete: 'Devre dışı bırak',
    confirmDelete: 'Bu kullanıcıyı devre dışı bırakmak istiyor musunuz? (mantıksal silme)',
    save: 'Kaydet',
    saving: 'Kaydediliyor...',
    cancel: 'İptal',
    loginRequired: 'Kullanıcıları yönetmek için yönetici olarak oturum açın.',
    forbidden: 'Bu bölüme yalnızca yöneticiler erişebilir.',
    sessionInvalid: 'Oturum backend için geçerli değil. Çıkış yapıp yönetici olarak yeniden giriş yapın.',
    loadFailed: 'Kullanıcılar yüklenemedi.',
    saveFailed: 'Kullanıcı kaydedilemedi.',
    deleteFailed: 'Kullanıcı devre dışı bırakılamadı.',
    cannotDeactivateAdmin: 'Yönetici devre dışı bırakılamaz',
  },
  adminAnalisis: {
    ...
    request: 'Request',
    response: 'Response',
    loginRequired: 'Analizleri görmek için yönetici olarak oturum açın.',
    forbidden: 'Bu bölüme yalnızca yöneticiler erişebilir.',
    sessionInvalid: 'Oturum backend için geçerli değil. Çıkış yapıp yönetici olarak yeniden giriş yapın.',
    loadFailed: 'Analizler yüklenemedi.',
  },
  contact: {
    title: 'Bize ulaşın',
