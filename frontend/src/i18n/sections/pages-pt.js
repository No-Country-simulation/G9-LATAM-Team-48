...
export const pagesPt = {
  ...
  "analysis": {
    ...
    "loginRequired": "Para receber o relatório da análise por e-mail, inicie sessão ou registre-se.",
    "emailLoginHint": "Para receber o relatório da análise por e-mail, inicie sessão ou registre-se.",
    ...
    "tipsList": {
      ...
      "commercial": "Otimizar horários e equipamentos do estabelecimento comercial",
      "house": "Priorizar isolamento e climatização eficiente na casa",
      "apartment": "Aproveitar áreas comuns e reduzir standby no apartamento",
      "default": "Priorizar iluminação LED e equipamentos com boa eficiência energética",
