...
export const pagesEn = {
  ...
  analysis: {
    ...
    types: {
      casa: 'Home',
      fabrica_mediana: 'Medium factory',
      fabrica_grande: 'Large factory',
    },
    typeHints: {
      casa: 'Home data to estimate usage per person and climate control.',
      fabrica_mediana: 'Operations data to compare machines, shifts and intensity.',
      fabrica_grande: 'Plant data to assess lines, capacity and monitoring.',
    },
    monthlyUsage: 'Monthly usage (kWh)',
    people: 'Number of people',
    devices: 'Number of devices',
    homeArea: 'Home floor area (m²)',
    climateHours: 'Climate-control hours per day',
    peakUseHours: 'Heavy-use hours per day',
