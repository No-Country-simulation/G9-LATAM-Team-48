...
export const pagesEn = {
  ...
  chart: {
    ...
    filters: {
      ...
      tiposListHint:
        'Ctrl+click (Mac: ⌘) to select multiple in the list. No selection = all types.',
  ...
  analysis: {
    ...
    statusSending: 'Sending data…',
    statusAnalyzing: 'Analyzing…',
    statusDone: 'Done',
    statusStepSend: 'Sending',
    statusStepAnalyze: 'Analyzing',
    statusStepDone: 'Done',
  ...
  adminAnalisis: {
    ...
    refresh: 'Refresh',
    recalculate: 'Recalculate with the AI model',
    recalculating: 'Recalculating…',
    recalculateConfirm:
      'Recalculate all saved analyses with the current AI model? It may take a while depending on how many queries there are. No emails are sent and no new queries are created.',
    recalculateDone:
  ...
  historiaConsumos: {
    ...
    filterAll: 'All',
    filterNivelMulti: 'Uncheck to filter; all three checked = all levels.',
